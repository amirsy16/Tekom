...
use App\Filament\Widgets\TowerMapWidget;
...
class AdminPanelProvider extends PanelProvider
{
    ...
    public function boot(): void
    {
        FilamentView::registerRenderHook(
            'panels::body.end',
            fn (): string => Blade::render("<script src='https://api.mapbox.com/mapbox-gl-js/v3.4.0/mapbox-gl.js'></script>"),
        );
    }
}
